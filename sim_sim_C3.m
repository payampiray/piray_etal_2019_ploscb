function sim_sim_C4(ii,simcat,simstr,simcat0,simstr0,m0,v0)

for i=ii
    simrun(simcat,simstr,i,simcat0,simstr0,m0,v0);
end

end

function simrun(simcat,simstr,id,simcat0,simstr0,m0,v0)
...
config2.save_prog  = 0;
nn = 1:length(data);
hbmc_lap(data,models,flap,init,v0,config1,config2,nn,m0);
